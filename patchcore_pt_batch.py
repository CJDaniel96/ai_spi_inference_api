...
# 3. Prepare test data with batch configuration
...
# 4. Get predictions with batch processing
# Create datamodule from dataset with batch size control
from anomalib.data import PredictDataModule
