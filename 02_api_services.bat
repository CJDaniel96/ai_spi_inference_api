...
set "PYTHON_EXE=C:\Users\Admin\.conda\envs\spi_prd\python.exe"
...
start "SPI_02_Anomaly_8000" cmd /k "cd /d "%~dp0" && "%PYTHON_EXE%" patchcore_server.py --host 0.0.0.0 --port 8000"

timeout /t 1 >nul 2>nul

REM Launch Paste Detection Server (8001)
start "SPI_02_Paste_8001" cmd /k "cd /d "%~dp0" && "%PYTHON_EXE%" paste_detection_server.py --host 0.0.0.0 --port 8001"

timeout /t 1 >nul 2>nul

REM Launch Distance Detection Server (8002)
start "SPI_02_Distance_8002" cmd /k "cd /d "%~dp0" && "%PYTHON_EXE%" distance_detection_server.py --host 0.0.0.0 --port 8002"
